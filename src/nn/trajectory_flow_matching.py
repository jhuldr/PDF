# nn/trajectory_flow_matching.py
import os
import torch
import torch.nn as nn
from nn.tfm_backbone import PDFUNet, PDFUNet_2head, PDFUNet_mask
...
class PDF(nn.Module):
    ...
    def forward(self, x_img: torch.Tensor, m_prob: torch.Tensor, s: torch.Tensor, delta_t: torch.Tensor):
        return self.net(x_img, m_prob, s, delta_t)


# ============================================================
# PDF model with 2 output head
# ============================================================
class PDF_2head(nn.Module):
    naming = "PDF_2head"
